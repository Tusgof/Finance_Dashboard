    ...
    <div className="scenario-panel">
      ...
      <div className="slider-grid">
        ...
        <div className="slider-group">
          ...
          <input type="range" min={-50} max={0} step={5} value={execAdj} onChange={e => setExecAdj(+e.target.value)} />
        </div>
        <div className="slider-group">
          <label>Production Cost Adjustment</label>
          <div className="slider-value">{prodAdj >= 0 ? '+' : ''}{prodAdj}%</div>
          <input type="range" min={-30} max={30} step={5} value={prodAdj} onChange={e => setProdAdj(+e.target.value)} />
        </div>
      </div>
      <div className="scenario-results">
        ...
        <div className="scenario-result">
          ...
          <div className="sr-value" style={{ color: newRunway >= 6 ? 'var(--accent-green)' : newRunway >= 3 ? 'var(--accent-amber)' : 'var(--accent-red)' }}>
