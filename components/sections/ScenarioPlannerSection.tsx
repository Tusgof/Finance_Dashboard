    ...
    <div className="page-stack">
      <div className="health-grid" style={{ gridTemplateColumns: 'repeat(4, minmax(0, 1fr))' }}>
        <div className="health-card">
          ...
          <div className="health-status amber"><span className="health-dot amber"></span>Average recent outflow</div>
        </div>
        <div className="health-card">
          <div className="health-label">Best Case</div>
        ...
        <div className="health-card">
          <div className="health-label">Worst Case</div>
